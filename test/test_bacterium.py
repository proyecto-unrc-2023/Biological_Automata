import pytest
from models.logic.Bacterium import Bacterium, BacteriumStrong, BacteriumNormal
from models.logic.Bacterium import BacteriumInfected, BacteriumWeak
...
def test_bacterium_isReproducible():
    ...
    assert bacterium.moves == 1 and value is None

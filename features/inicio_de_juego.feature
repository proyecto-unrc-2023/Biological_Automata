...
Característica: Se inicia el juego
  ...
  Esquema del escenario: Se posicionan los spawn
    Dado que el usuario abrio el juego
    Y se creo el juego con los siguientes parametros (50,3,100,3,<modo>)
    ...
    #ver despues lo de las posiciones comentadas, deberia dejarse listo una vez
    #que se decida el tamaño final del tablero

...
Característica: Comportamiento de las entidades
 ...
 Esquema del escenario: Una bacteria debil no se reproduce
  ...
  Esquema del escenario: Las bacterias salen del spawn y luego se reproducen
    ...
    Y se coloco el spawn de la otra entidad en (14,14)
  ...
  Esquema del escenario: Los antibioticos salen del spawn y se acumulan en el tablero si no hay bacterias
    Dado que el usuario abrio el juego
    Y los parametros iniciales del juego son (0,10,<cant_a>,<frec_a>)
    Y se coloco el spawn de bacterias en (2,2)
    Y se coloco el spawn de la otra entidad en (5,5)
    Y el modo de juego elegido es antibiotico
    Y el usuario inicio el juego
    Cuando ha pasado <turnos> turno de juego
    Entonces deberian quedar <cant_a_act> antibioticos por salir del spawn
    Y el tablero deberia quedar con <a_en_tablero> antibioticos

    Ejemplos:

      | cant_a | frec_a  |turnos  |cant_a_act |a_en_tablero|
      |  25    |  2      |  10    |    20     |    5       |
      |  25    |  8      |  60    |    17     |    8       |
      |  30    |  1      |  15    |    15     |    15      |
      |  17    |  2      |  70    |    0      |    17      |